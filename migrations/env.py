...
from stocks.models import metadata as metadata_stocks
...
config.set_section_option(sections, "DB_PORT", str(DB_PORT))
...
target_metadata = [metadata_users, metadata_stocks]
